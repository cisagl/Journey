...
public class MobilePhoneOperations extends MobilePhones{
    ...
    public MobilePhoneOperations(int id, double price, int discountRate, int stock, String name, int memory, double screenSize, int ram, Brand brand, int battery, String color) {
