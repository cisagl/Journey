...
public class BattleLoc extends Location {
    ...
    public BattleLoc(Player player, String name, Obstacle obstacle, String award, int maxObstacle, boolean obje) {
        super(player, name);
    ...
    public boolean combat(int obsNumber) {
        for (int i = 1; i <= obsNumber; i++) {
            ...
            if (this.getObstacle().getHealth() < this.getPlayer().getHealth()) {
                ...
                this.getPlayer().getInventory().setObje(true);
                System.out.println(this.getObstacle().getAward() + " para kazandınız!\nGüncel paranız: " + this.getPlayer().getMoney());
                System.out.println();
            }
        }
        return false;
